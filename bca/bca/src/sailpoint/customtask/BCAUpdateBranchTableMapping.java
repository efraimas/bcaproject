...
public class BCAUpdateBranchTableMapping extends AbstractTaskExecutor{
	public static String CLASS_NAME = "::BCAUpdateBranchTableMapping::";
	public static Logger logger = Logger.getLogger("sailpoint.customtask.BCAUpdateBranchTableMapping");
