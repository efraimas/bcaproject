...
public class AppBnoProvisioning {

	public static String CLASS_NAME = "::AppBnoProvisioning::";
	public static Logger logger = Logger.getLogger("sailpoint.provisioningpolicy.rule.AppBnoProvisioning");
	
	public static Object getUser_ID_BNUSER(SailPointContext context, Identity identity, ProvisioningProject project) throws GeneralException
	{
		String METHOD_NAME = "::getUser_ID_BNUSER::";
		...
		String sequenceObject = "BCA_BNO_Sequence";
