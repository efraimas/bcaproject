...
public class AppLldProvisioning {

	public static String CLASS_NAME = "::AppLldProvisioning::";
	public static Logger logger = Logger.getLogger("sailpoint.provisioningpolicy.rule.AppLldProvisioning");
	
	public static Object getUser_ID_LLD(SailPointContext context, Identity identity, ProvisioningProject project) throws GeneralException
	{
		String METHOD_NAME = "::getUser_ID_LLD::";
		...
		String sequenceObject = "BCA_LLD_Sequence";
