...
public class AppSkrProvisioning {

	public static String CLASS_NAME = "::AppSkrProvisioning::";
	public static Logger logger = Logger.getLogger("sailpoint.provisioningpolicy.rule.AppSkrProvisioning");

	public static Object getUser_ID_SKR(SailPointContext context, Identity identity, ProvisioningProject project) throws GeneralException{
		
		String METHOD_NAME = "::getUser_ID_SKR::";
		...
		String sequenceObject = "BCA_SKR_Sequence";
