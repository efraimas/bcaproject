...
public class AppDfnProvisioning {

	public static String CLASS_NAME = "::AppDfnProvisioning::";
	public static Logger logger = Logger.getLogger("sailpoint.provisioningpolicy.rule.AppDfnProvisioning");

	public static Object getUser_ID_DFN(SailPointContext context, Identity identity, ProvisioningProject project) throws GeneralException{
		
		String METHOD_NAME = "::getUser_ID_DFN::";
		...
		String sequenceObject = "BCA_DFN_Sequence";
