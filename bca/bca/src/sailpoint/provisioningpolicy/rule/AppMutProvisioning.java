...
public class AppMutProvisioning {

	public static String CLASS_NAME = "::AppMutProvisioning::";
	public static Logger logger = Logger.getLogger("sailpoint.provisioningpolicy.rule.AppMutProvisioning");

	public static Object getUser_ID_MUT(SailPointContext context, Identity identity, ProvisioningProject project) throws GeneralException{
		
		String METHOD_NAME = "::getUser_ID_MUT::";
		...
		String sequenceObject = "BCA_MUT_Sequence";
