...
public class AppCbgProvisioning {
	
	public static String CLASS_NAME = "::AppCbgProvisioning::";
	public static Logger logger = Logger.getLogger("sailpoint.provisioningpolicy.rule.AppCbgProvisioning");

	public static Object getUser_ID_CBG(SailPointContext context, Identity identity, String oldPrefix, ProvisioningProject project) throws GeneralException{
		
		String METHOD_NAME = "::getUser_ID_CBG::";
		...
		if(links != null && links.size() > 0){
			...
			while(it.hasNext()){
				...
				if("IBM MAINFRAME RACF".equalsIgnoreCase(link.getApplicationName())){
					...
					if(userId.substring(0, 2).equalsIgnoreCase("BG")){
		...
		String sequenceObject = "BCA_CBG_Sequence";
