...
public class AppKotProvisioning {

	public static String CLASS_NAME = "::AppKotProvisioning::";
	public static Logger logger = Logger.getLogger("sailpoint.provisioningpolicy.rule.AppKotProvisioning");

	public static Object getUser_ID_KOT(SailPointContext context, Identity identity, String oldPrefix, ProvisioningProject project) throws GeneralException{
		
		String METHOD_NAME = "::getUser_ID_KOT::";
		...
		if(links != null && links.size() > 0){
			...
			while(it.hasNext()){
				...
				if("IBM MAINFRAME RACF".equalsIgnoreCase(link.getApplicationName())){
					...
					if(userId.substring(0, 1).equalsIgnoreCase("K") && AccountSelectorRule.isNumber(userId.substring(1,2))==true){
		...
		String sequenceObject = "BCA_KOT_Sequence";
