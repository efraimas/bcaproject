...
public class AppIdGlProvisioning {

	public static String CLASS_NAME = "::AppIdGlProvisioning::";
	public static Logger logger = Logger.getLogger("sailpoint.provisioningpolicy.rule.AppIdGlProvisioning");

	public static Object getUser_ID_GL(SailPointContext context, Identity identity, String oldPrefix, ProvisioningProject project) throws GeneralException{
		
		String METHOD_NAME = "::getUser_ID_GL::";
		...
		if(links != null && links.size() > 0){
			...
			while(it.hasNext()){
				...
				if("IBM MAINFRAME RACF".equalsIgnoreCase(link.getApplicationName())){
					...
					if(userId.substring(0, 2).equalsIgnoreCase("GL")){
		...
		String sequenceObject = "BCA_GL_Sequence";
