...
public class AppIdTProvisioning {

	public static String CLASS_NAME = "::AppIdTProvisioning::";
	public static Logger logger = Logger.getLogger("sailpoint.provisioningpolicy.rule.AppIdTProvisioning");

	public static Object getUser_ID_T(SailPointContext context, Identity identity, String oldPrefix, ProvisioningProject project) throws GeneralException{
		
		String METHOD_NAME = "::getUser_ID_T::";
		...
		if(links != null && links.size() > 0){
			...
			while(it.hasNext()){
				...
				if("IBM MAINFRAME RACF".equalsIgnoreCase(link.getApplicationName())){
					...
					if(userId.substring(0, 1).equalsIgnoreCase("T") && AccountSelectorRule.isNumber(userId.substring(2,3))==true){
		...
		String sequenceObject = "BCA_T_Sequence";
