...
public class AppUgpProvisioning {

	public static String CLASS_NAME = "::AppUgpProvisioning::";
	public static Logger logger = Logger.getLogger("sailpoint.provisioningpolicy.rule.AppUgpProvisioning");

	public static Object getUser_ID_UGP(SailPointContext context, Identity identity, ProvisioningProject project) throws GeneralException{
		
		String METHOD_NAME = "::getUser_ID_UGP::";
		...
		String sequenceObject = "BCA_UGP_Sequence";
