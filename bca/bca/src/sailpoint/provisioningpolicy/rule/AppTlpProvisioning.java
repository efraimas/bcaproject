...
public class AppTlpProvisioning {

	public static String CLASS_NAME = "::AppTlpProvisioning::";
	public static Logger logger = Logger.getLogger("sailpoint.provisioningpolicy.rule.AppTlpProvisioning");

	public static Object getUser_ID_TLP(SailPointContext context, Identity identity, ProvisioningProject project) throws GeneralException{
		...
		String sequenceObject = "BCA_TLP_Sequence";
