...
public class AppIdSaProvisioning {

	public static String CLASS_NAME = "::AppIdSaProvisioning::";
	public static Logger logger = Logger.getLogger("sailpoint.provisioningpolicy.rule.AppKugProvisioning");

	public static Object getUser_ID_SA(SailPointContext context, Identity identity, String oldPrefix, ProvisioningProject project) throws GeneralException{
		
		String METHOD_NAME = "::getUser_ID_SA::";
		...
		if(links != null && links.size() > 0){
			...
			while(it.hasNext()){
				...
				if("IBM MAINFRAME RACF".equalsIgnoreCase(link.getApplicationName())){
					...
					if(userId.substring(0, 2).equalsIgnoreCase("SA")){
		...
		String sequenceObject = "BCA_SA_Sequence";
